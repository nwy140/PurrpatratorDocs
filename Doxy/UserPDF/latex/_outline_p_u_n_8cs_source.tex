\doxysection{Outline\+PUN.\+cs}
\label{_outline_p_u_n_8cs_source}\index{C:/\_SSDSPEEDUP/2021/GPS/gps2\_purrpatrator/GPS2\_Purrpatrator/Assets/\_Developers/WeiYuen/Scripts/Shader/OutlinePUN.cs@{C:/\_SSDSPEEDUP/2021/GPS/gps2\_purrpatrator/GPS2\_Purrpatrator/Assets/\_Developers/WeiYuen/Scripts/Shader/OutlinePUN.cs}}
...
\DoxyCodeLine{00015 \textcolor{keyword}{public} \textcolor{keyword}{class }OutlinePUN : MonoBehaviour \{}
\DoxyCodeLine{00016   \textcolor{keyword}{private} \textcolor{keyword}{static} HashSet<Mesh> registeredMeshes = \textcolor{keyword}{new} HashSet<Mesh>();}
\DoxyCodeLine{00017 }
\DoxyCodeLine{00018   \textcolor{keyword}{public} \textcolor{keyword}{enum} Mode \{}
\DoxyCodeLine{00019     OutlineAll,}
\DoxyCodeLine{00020     OutlineVisible,}
\DoxyCodeLine{00021     OutlineHidden,}
\DoxyCodeLine{00022     OutlineAndSilhouette,}
\DoxyCodeLine{00023     SilhouetteOnly}
\DoxyCodeLine{00024   \}}
\DoxyCodeLine{00025 }
\DoxyCodeLine{00026   \textcolor{keyword}{public} Mode OutlineMode \{}
\DoxyCodeLine{00027     \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} outlineMode; \}}
\DoxyCodeLine{00028     \textcolor{keyword}{set} \{}
\DoxyCodeLine{00029       outlineMode = value;}
\DoxyCodeLine{00030       needsUpdate = \textcolor{keyword}{true};}
\DoxyCodeLine{00031     \}}
\DoxyCodeLine{00032   \}}
\DoxyCodeLine{00033 }
\DoxyCodeLine{00034   \textcolor{keyword}{public} Color OutlineColor \{}
\DoxyCodeLine{00035     \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} outlineColor; \}}
\DoxyCodeLine{00036     \textcolor{keyword}{set} \{}
\DoxyCodeLine{00037       outlineColor = value;}
\DoxyCodeLine{00038       needsUpdate = \textcolor{keyword}{true};}
\DoxyCodeLine{00039     \}}
\DoxyCodeLine{00040   \}}
\DoxyCodeLine{00041 }
\DoxyCodeLine{00042   \textcolor{keyword}{public} \textcolor{keywordtype}{float} OutlineWidth \{}
\DoxyCodeLine{00043     \textcolor{keyword}{get} \{ \textcolor{keywordflow}{return} outlineWidth; \}}
\DoxyCodeLine{00044     \textcolor{keyword}{set} \{}
\DoxyCodeLine{00045       outlineWidth = value;}
\DoxyCodeLine{00046       needsUpdate = \textcolor{keyword}{true};}
\DoxyCodeLine{00047     \}}
\DoxyCodeLine{00048   \}}
\DoxyCodeLine{00049 }
\DoxyCodeLine{00050   [Serializable]}
\DoxyCodeLine{00051   \textcolor{keyword}{private} \textcolor{keyword}{class }ListVector3 \{}
\DoxyCodeLine{00052     \textcolor{keyword}{public} List<Vector3> data;}
\DoxyCodeLine{00053   \}}
\DoxyCodeLine{00054 }
\DoxyCodeLine{00055   [SerializeField]}
\DoxyCodeLine{00056   \textcolor{keyword}{private} Mode outlineMode;}
\DoxyCodeLine{00057 }
\DoxyCodeLine{00058   [SerializeField]}
\DoxyCodeLine{00059   \textcolor{keyword}{private} Color outlineColor = Color.white;}
\DoxyCodeLine{00060 }
\DoxyCodeLine{00061   \textcolor{comment}{//[SerializeField, Range(0f, 100000f)]}}
\DoxyCodeLine{00062     [SerializeField]}
